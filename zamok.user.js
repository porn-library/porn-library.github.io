...
// @author vk.com/it256
// @include http://zamok.spaces-games.com/*
// ==/Userscript==
(function(){
if(location.href.match('zamok.spaces-games.com')) {
var i=0;
var tx='';
speed=1;
/*
...
cnt[i]=new Array();
for(q=0;q<document.getElementsByTagName('tr').length-1;q++){
cnt[i][q]=document.getElementsByTagName('td').
